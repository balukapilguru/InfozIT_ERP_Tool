  ...
  switch (action.type) {
    ...
    case ActionTypes.SET_BRANCH_DETAILS:
      if (
        ...
        action?.payload?.context === "SET_BRANCH_ID_IN_TODAY_FEE_RECEVIED"
      ) {
        return {
          ...state,
    ...
    case ActionTypes.SET_COUNCELLOR_DETAILS:
      if (
        ...
        action?.payload?.context === "SET_COUNCELLOR_ID_IN_TODAY_FEE_RECEVIED"
      ) {
        return {
          ...state,
    ...
    case ActionTypes.SET_LOADING:
      if (action?.payload?.context === "TOTAL_ENROLLMENT_DETAILS") {
        ...
        console.log(state.TotalEnrollementDetails, "fgjdfjdf")
        return {
          ...state,
          TotalEnrollementDetails: {
            ...state.TotalEnrollementDetails,
      ...
      if (action?.payload?.context === "SET_LIVE_USER_COUNT") {
        console.log(state.TotalEnrollementDetails, "fgjdfjdf")
        return {
          ...state,
          LiveUsersCount: {
            ...state.LiveUsersCount,
            loading: !state?.LiveUsersCount?.loading,
          },
        };
      }
        ...
        action?.payload?.context === "TODAY_FEE_RECEIVED_BY_COUNCELLORSWISE"
      ) {
        return {
          ...state,
          TodayFeeReceviedByCouncellors: {
        ...
        action?.payload?.context === "TODAY_FEE_RECEIVED_BY_STUDENTS_WISE"
      ) {
        return {
          ...state,
          TodayFeeReceviedByStudents: {
      ...
      if (action?.payload?.context === "TOTAL_ENROLLMENT_DETAILS") {
        ...
        return {
          ...
          TotalEnrollmentGraph: {
            ...
            lastMonthEnrollmentsAsOnDate:
              reducerData?.lastMonthAsOnDateEnrollments,
            currentMonthBookingAmountAsOnDate:
              reducerData?.currentMonthFinalTotal,
            currentMonthFeeRecievedAsOnDate:
              reducerData?.currentMonthFeeRecevied,
          },
        };
      }
      ...
      if (action?.payload.context === "TOTAL_FEE_DETAILS") {
        ...
        return {
          ...
          TotalFeeDetailsGraph: {
            ...
            lastThreeMonthsFeeYetToReceive:
              reducerData?.lastThreeMonthsFeeYetToReceive,

            lastMonthFeeReceivedAsOnDate:
              reducerData?.lastMonthFeeReceivedAsOnDate,
            withoutGstCurrentFeeReceived:
              reducerData?.withoutGstCurrentFeeReceived,
          },
        };
      }
    ...
    case ActionTypes.SET_PAGINATED_TODAY_FEE_RECEVIED:
      if (action?.payload?.context === "SET_TODAY_FEE_RECEIVED") {
        ...
        action?.payload?.context === "SET_TODAY_FEE_RECEIVED_BY_COUNCELLORSWISE"
      ) {
        const reducerData = action?.payload?.data;
        ...
        action?.payload?.context === "SET_TODAY_FEE_RECEIVED_BY_STUDENTS_WISE"
      ) {
        const reducerData = action?.payload?.data;
    ...
    case ActionTypes.SET_LIVE_USER_COUNT:
      if (action?.payload?.context === "SET_LIVE_USER_COUNT") {
        const reducerData = action?.payload?.data;
